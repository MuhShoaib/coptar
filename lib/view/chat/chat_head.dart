                    ...
                    return Obx(() => SliverList(
                          delegate: SliverChildBuilderDelegate(
                            (context, index) {
                              ...
                              var data = chatController.inboxList.value[index];
...
class ChatHeadTiles extends StatelessWidget {
  ChatHeadTiles({Key? key, required this.employeListItem}) : super(key: key);
        ...
        child: ListTile(
          ...
          leading: Column(
            ...
            children: [
              ...
              // Image.asset("assets/images/dummy_chat/skylar.png")
            ],
          ),
          title: MyText(
          ...
          subtitle: MyText(
            ...
            maxLines: 1,
            overFlow: TextOverflow.ellipsis,
            // color: employeListItem.name == true ? kBlackColor2 : kDarkPurpleColor,
          ),
          trailing: Column(
            ...
            children: [
              MyText(
                ...
                // color: unreadMsg == true ? kBlackColor2 : kDarkPurpleColor,
              ),
            ],
          ),
        ),
