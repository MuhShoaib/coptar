...
import 'package:copter/view/company/give_rating.dart';
                              ...
                              children: [
                                Padding(
                                  ...
                                  child: TaskDetails(
                                    ...
                                    timeLeft:
                                        "${DateTime.parse(data['end']).difference(
                                              DateTime.now(),
                                            ).inDays} Days",
                                  ),
                                ),
              ...
              children: [
                        ...
                        children: [
                          ...
                          if (widget.indicatorProgress != 1.0)
                            MyText(
                              paddingTop: 5,
                              text:
                                  '${DateTime.parse(data['end']).difference(DateTime.now()).inDays} days',
                              weight: FontWeight.w500,
                              color: kBlackColor2,
                            )
                        ],
                ...
                Row(
                  ...
                  children: [
                    ...
                    MyText(
                      text:
                          '${getProgress(widget.indicatorProgress!)}% complete',
                      size: 12,
                ...
                LinearPercentIndicator(
                  lineHeight: 7,
                  percent:
                      progress == null ? 0.0 : double.parse(progress!) / 100,
